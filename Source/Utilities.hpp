...
#define CLASS_NAME_TEMPLATE(ct) template <> constexpr char ClassName<ct>[] = #ct

namespace bbm {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wexit-time-destructors"
template <class T> constexpr char ClassName[] = "T";
...
template <class To, class From> inline To castCheck(const From &from);
} // namespace bbm
